...
import com.mycode.hibernate.demo.entity.Review;
...
public class CreateCourseAndStudentsDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Student tempStudent2 = new Student("Mary", "Public", "mary@mycode.com");
			Student tempStudent3 = new Student("Tina", "Sonia", "tina@mycode.com");
