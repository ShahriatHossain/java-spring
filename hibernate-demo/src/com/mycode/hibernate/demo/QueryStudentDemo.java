...
public class QueryStudentDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// query students where email LIKE 'mycode.com'
			theStudents = session.createQuery("from Student s where" + " s.email LIKE '%mycode.com'").getResultList();

			// display the students
			System.out.println("\n\nStudents who email ends with mycode.com");
			displayStudents(theStudents);
